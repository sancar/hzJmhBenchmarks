...
public class IdentifiedSampleFactory {

    public static TweetObject create(MetadataCreator creator) {
        TweetLocationObject locationObject = new IDSTweetLocationObject();
        locationObject.setCity(creator.getCity());
        locationObject.setCountry(creator.getCountry());

        TweetUserObject userObject = new IDSTweetUserObject();
        ...
        TweetObject object = new IDSTweetObject();

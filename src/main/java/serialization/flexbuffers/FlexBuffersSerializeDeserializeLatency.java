...
public class FlexBuffersSerializeDeserializeLatency {
    ...
    public static void main(String[] args) throws IOException {
        FlexBuffersSerializeDeserializeLatency test = new FlexBuffersSerializeDeserializeLatency();
        test.prepare();
    ...
    private static void test() {
        Options opt = new OptionsBuilder()
                .include(FlexBuffersSerializeDeserializeLatency.class.getSimpleName())
                .forks(1)
                .build();

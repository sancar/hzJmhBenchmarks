...
public class ProtoQueryLatency {
    ...
    public static void main(String[] args) throws IOException {
        ProtoQueryLatency protoQueryLatency = new ProtoQueryLatency();
        protoQueryLatency.prepare();
        System.out.println(protoQueryLatency.testQueryUser_location_city());
        System.out.println(protoQueryLatency.testQueryCreatedAt());
        test();
    }

    private static void test() {
        Options opt = new OptionsBuilder()
                .include(ProtoQueryLatency.class.getSimpleName())
                .forks(1)
                .build();

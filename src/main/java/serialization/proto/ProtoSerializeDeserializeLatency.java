...
public class ProtoSerializeDeserializeLatency {
    ...
    @Benchmark
    public ProtoTweetObject.TweetObject  testToObject() throws IOException {
        return toObject(data);
    }

    public static void main(String[] args) throws IOException {
        ProtoSerializeDeserializeLatency test = new ProtoSerializeDeserializeLatency();
        test.prepare();
    ...
    private static void test() {
        Options opt = new OptionsBuilder()
                .include(ProtoSerializeDeserializeLatency.class.getSimpleName())
                .forks(1)
                .build();

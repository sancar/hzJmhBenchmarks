...
public class ObjectSerializeDeserializeLatency {
    ...
    public static void main(String[] args) throws IOException {
        ObjectSerializeDeserializeLatency test = new ObjectSerializeDeserializeLatency();
        test.prepare();
        test();
    }
    ...
    private static void test() {
        Options opt = new OptionsBuilder()
                .include(ObjectSerializeDeserializeLatency.class.getSimpleName())
                .forks(1)
                .build();

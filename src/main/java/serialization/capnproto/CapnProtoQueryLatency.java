...
public class CapnProtoQueryLatency {
...
//        org.capnproto.SerializePacked.writeToUnbuffered(wbc, message);
    ...
    public static void main(String[] args) throws IOException {
        CapnProtoQueryLatency capnProtoQueryLatency = new CapnProtoQueryLatency();
        capnProtoQueryLatency.prepare();
        System.out.println("Data length " + capnProtoQueryLatency.data.length);
        System.out.println(capnProtoQueryLatency.testQueryUser_location_city());
        System.out.println(capnProtoQueryLatency.testQueryCreatedAt());
        test();
    }

    private static void test() {
        Options opt = new OptionsBuilder()
                .include(CapnProtoQueryLatency.class.getSimpleName())
                .forks(1)
                .build();
